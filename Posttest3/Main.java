...
public class Main {
   static ArrayList<spt_NonFormal>nonFormal = new ArrayList<spt_NonFormal>();
   static ArrayList<spt_Formal>Formal = new ArrayList<spt_Formal>();
...
public static void tambahSPT()throws IOException{
    ...
    switch (pilih) {
        case 1 -> {
            ...
            Posttest3.spt_Formal sptFormal = new Posttest3.spt_Formal(addmerek, addwarna, addciri_ciri, addukuran, addharga);
            Formal.add(sptFormal);
           }
         
        case 2 -> {
            System.out.println("------------------------------------------" );
            System.out.println("     Tambahkan Data Sepatu Non Formal     " );
            System.out.println("------------------------------------------" );
            System.out.print("Masukan Merek Sepatu  : ");
            ...
            Posttest3.spt_NonFormal sptNonFormal = new Posttest3.spt_NonFormal(addmerek1, addwarna1, addjenis, addukuran1, addharga1);
