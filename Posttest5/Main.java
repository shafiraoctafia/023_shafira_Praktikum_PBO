...
public static void tambahSPT()throws IOException{
    ...
    switch (pilih) {
        case 1 -> {
            ...
            Posttest5.spt_Formal sptFormal = new Posttest5.spt_Formal(addmerek, addwarna, addciri_ciri, addukuran, addharga);
        ...
        case 2 -> {
            ...
            Posttest5.spt_NonFormal sptNonFormal = new Posttest5.spt_NonFormal(addmerek1, addwarna1, addjenis, addukuran1, addharga1);
